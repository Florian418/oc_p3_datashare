      ...
      <div class="download__stage">
        <div class="download__card">
          ...
          <div class="download__body">
            ...
            @switch (state()) {
              @case ('protege') {
                <app-callout type="info">Ce fichier expirera dans 3 jours.</app-callout>
              ...
              @case ('libre') {
                <app-callout type="alert">Ce fichier expirera demain.</app-callout>
              }
              @case ('expire') {
          ...
          @if (state() !== 'expire') {
            <app-button variant="primary" size="medium" [fullWidth]="true" [disabled]="protectedAndEmpty()">
...
export class Download {
  protected state = signal<DownloadState>('protege');
