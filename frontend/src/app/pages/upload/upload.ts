        ...
        @switch (state()) {
          @case ('vide') {
            <div class="upload__intro">
              ...
              <button type="button" class="upload__trigger" aria-label="Choisir un fichier à partager">
          ...
          @case ('ajoute') {
            <div class="upload__card">
              ...
              <div class="upload__file">
                ...
                <app-button variant="secondary" size="small">Changer</app-button>
              </div>
              <form class="upload__form">
                ...
                <app-button variant="primary" size="medium" type="submit">
          ...
          @case ('erreur') {
            <div class="upload__card">
              ...
              <div class="upload__file">
                ...
                <div class="upload__file-info">
                  <span class="upload__file-name">IMG_9210.jpg</span>
                  <span class="upload__file-size upload__file-size--error">3,1 Go</span>
                </div>
                <app-button variant="secondary" size="small">Changer</app-button>
              </div>
          ...
          @case ('succes') {
            <div class="upload__card upload__card--success">
              ...
              <p class="upload__success-text">Félicitations, ton fichier sera conservé chez nous pendant une semaine !</p>
              <div class="upload__link">
                <a href="https://datashare.fr/UhGyr">https://datashare.fr/UhGyr</a>
              </div>
              <app-button variant="primary" size="medium" [fullWidth]="true">
...
export class Upload {
  ...
  protected fileName = signal('IMG_9210_123123131313213231.jpg');
  protected fileSize = signal('2,6 Mo');
